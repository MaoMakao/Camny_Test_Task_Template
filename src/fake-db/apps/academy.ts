// Type Imports
import { LessonStatuses, type AcademyType } from '@/types/apps/academyTypes'
...
export const db: AcademyType = {
  ...
  student: {
    ...
    registrationDate: '3/07/2024',
    image: '/images/avatars/11.jpg',
    lessons: [
      {
        id: 1,
        name: 'Endocrinology Basics',
        date: '6/07/2024',
        status: LessonStatuses.REQUESTED
      },
      {
        id: 2,
        name: 'Cardiovascular System Studies',
        date: '6/07/2024',
        status: LessonStatuses.REQUESTED
      },
      {
      ...
      {
        id: 5,
        name: 'Immunology Fundametals',
        date: '6/07/2024',
        status: LessonStatuses.DONE
      },
      {
        id: 6,
        name: 'Advanced Cardioplumonary Systems',
        date: '6/07/2024',
        status: LessonStatuses.DONE
      },
      {
        id: 7,
        name: 'Dermatology and Skin Disorders',
        date: '6/07/2024',
        status: LessonStatuses.DONE
      },
      {
        id: 8,
        name: 'Orthopedics and Musculosceletal Health',
        date: '6/07/2024',
      ...
      {
        id: 10,
        name: 'Obstetrics and Ginecology',
        date: '6/07/2024',
        status: LessonStatuses.CANCELED
      },
      {
        id: 11,
        name: 'Cardiovascular System Studies',
